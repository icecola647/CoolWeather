...
import com.example.weather_application.gson.Forecast;
import com.example.weather_application.gson.Weather;
import com.example.weather_application.service.AutoUpdateService;
...
//        初始化各个控件
    ...
    private void showWeatherInfo(Weather weather) {
        if (weather!=null&&"ok".equals(weather.status)){
            ...
            Toast.makeText(this, "获取天气信息", Toast.LENGTH_SHORT).show();
        }
    }
}